...
var _raceRelationsState = __webpack_require__(/*! ./race-relations-state */ "./src/race-relations-state.js");

var _raceRelationsState2 = _interopRequireDefault(_raceRelationsState);
...
game.state.add('Races', (0, _raceRelationsState2.default)(game));
...
function prisonersInstructionsState(game) {
    ...
    function create() {
        ...
        var raceButtonStyle = { font: '10pt Press Start 2P', fill: '#FFFFFF', align: 'right' };
        var raceButton = game.add.text(game.world.width - 270, 30, 'Prisoners (cont.) >', raceButtonStyle);
        ...
        raceButton.events.onInputUp.add(function () {
...
exports.default = raceRelationsState;
...
function raceRelationsState(game) {

    var arrowTextStyle = { font: '10pt Press Start 2P', fill: 'white', align: 'left', wordWrap: true, wordWrapWidth: game.width - 60 };
    ...
    var raceInstructions = 'Here is a diagram of the relationships between the prisoner types:';

    function preload() {}

    function create() {
        var backButtonStyle = { font: '10pt Press Start 2P', fill: '#FFFFFF', align: 'left' };
        var playButtonStyle = { font: '20pt Press Start 2P', fill: '#FFFFFF', align: 'left' };
        var backButton = game.add.text(60, 30, '< Back', backButtonStyle);
        ...
        races.forEach(function (raceName, i) {
            ...
            var prisoner = game.add.sprite(colStartX + spriteXOffset, currY, raceName);
            prisoner.animations.add('walk');
            prisoner.animations.play('walk', 8, true);
            prisoner.anchor.setTo(0, 0.5);

            var prisoner2 = game.add.sprite(colStartX + spriteX2Offset, currY, raceRelationsMap[raceName]);
        ...
        var aboutText = game.add.text(60, 90, raceInstructions, arrowTextStyle);
    }
